...
const EXTRA_TILES: TileItem[] = [
    ...
    { id: '4', name: 'TERRACOTTA ARCHES', image: '/tiles/terracotta.png', patternImage: '/tiles/terracotta.png', quantity: 0, unitPrice: 22.00 },
    { id: '5', name: 'NAVY ORBITS', image: '/tiles/navy.png', patternImage: '/tiles/navy.png', quantity: 0, unitPrice: 24.00 },
    { id: '6', name: 'AMALFI DOVES', image: '/tiles/amalfi.png', patternImage: '/tiles/amalfi.png', quantity: 0, unitPrice: 20.00 },
    { id: '7', name: 'ARTISAN FLORA', image: '/tiles/artisan.png', patternImage: '/tiles/artisan.png', quantity: 0, unitPrice: 34.00 },
    { id: '8', name: 'GEOMETRIC KILN', image: '/tiles/geometric.png', patternImage: '/tiles/geometric.png', quantity: 0, unitPrice: 30.00 },
